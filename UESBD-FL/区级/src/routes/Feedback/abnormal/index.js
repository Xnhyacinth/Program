...
import { Card, Popconfirm, Modal, Button, Icon, Table, Divider, BackTop, Affix, Anchor, Form, InputNumber, Input } from 'antd'
...
class TableDemo extends React.Component {
  ...
  columns8 = [
    ...
    },
    {
      ...
      render: (text, record) => {
        return <div>
          <Button type="primary" shape="round" onClick={() => this.onDelete(record.key)} style={{margin: 4}} >
            惩罚
          </Button>
          <Button type="primary" shape="round" onClick={() => this.onDelete(record.key)} danger>
          删除
          </Button>
        </div>
