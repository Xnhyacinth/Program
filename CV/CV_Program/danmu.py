...
class Danmu_layer:
    ...
    def __init__(self, frame_w, frame_h, danmu_txt):
        ...
        # 轨道颜色
        self.tracks_color = [(255, 255, 255, 255), (255, 0, 0, 255), (0, 255, 0, 255), (0, 0, 255, 255),
    ...
    def danmu_text2list(self):
        ...
        text_list = None
        # 读取弹幕文本
        with open(self.danmu_txt, 'r', encoding='utf-8') as f:
...
#     # 清除尾部换行符
#     text_list = [t.strip() for t in text_list]
# len_danmu_text = len(text_list)
# print(len_danmu_text)
# print(text_list)
# track_num = 7
# cols_num = math.ceil(len_danmu_text / track_num)
# print(cols_num)
# blank_arr = ['' for i in range(track_num * cols_num - len_danmu_text)]
# print(blank_arr)
# fixed_danmu_text = np.concatenate((text_list, blank_arr))
# print(fixed_danmu_text)
# indexes_arr = np.arange(track_num * cols_num).reshape((cols_num, track_num))
# print(indexes_arr.T)
# print(fixed_danmu_text[indexes_arr.T])
